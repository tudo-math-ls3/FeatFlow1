...
C=======================================================================
C
ccc      IF (((PZ.GT.0.00D0).AND.(PZ.LT.0.41D0)).AND.
ccc     *    ((PX.GE.0.45D0).AND.(PX.LE.0.55D0)).AND.
ccc     *    ((PY.GE.0.15D0).AND.(PY.LE.0.25D0))) THEN
ccc       IFLAG1=1      
ccc      ENDIF
C
ccc      IF (((PZ.GT.0.00D0).AND.(PZ.LT.0.41D0)).AND.
ccc     *    ((PX.GE.0.45D0).AND.(PX.LE.0.50D0)).AND.
ccc     *    ((PY.GE.0.15D0).AND.(PY.LE.0.25D0))) THEN
ccc       IFLAG2=1      
ccc      ENDIF
C
