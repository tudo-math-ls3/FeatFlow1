...
C
      CALL ZTIME(TTT0)
      CALL ZINIT(NNWORK,'feat.msg','#data/CC3D.ERR','#data/CC3D.PRT',
     *                             '#data/CC3D.SYS','#data/CC3D.TRC') 
      CALL ZTIME(TTT1)
      TTLC=TTLC+TTT1-TTT0
C
      MDATA=79
