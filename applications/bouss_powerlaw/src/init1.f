...
C
      ...
      KLF12P(ILEV)=LF12P
C
C allocation of a vector for local viscosities
C
...
C
      READ(MDATA,*) IGRAD
      IF (MSHOW.GE.2) 
     *     WRITE(MTERM,*) 'Use just gradient:  IGRAD = ', IGRAD
      IF (MSHOW.GE.0) 
     *     WRITE(MFILE,*) 'Use just gradient:  IGRAD = ', IGRAD
C
C-----------------------------------------------------------------------
