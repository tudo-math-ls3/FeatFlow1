************************************************************************
      SUBROUTINE TUPWDG(U1L1,U1L2,U2L1,U2L2,A1L,A2L,U1,U2,D1,D2,A,NA,
...
************************************************************************
      ...
      REAL A
C
      PARAMETER (NNBAS=21,NNDER=6,NNCUBP=36,NNVE=4,NNAB=21,NNLEV=9)
C
...
C
************************************************************************
      SUBROUTINE TUPWNP(U1L1,U1L2,U2L1,U2L2,A1L,A2L,U1,U2,D1,D2,A,NA,
     *                  KCOLA,KLDA,KVERT,KMID,DCORVG,ELE,COEF,
     *                  IDEF,ICOMP,DCMASS)
************************************************************************
*     Purpose: -  Adds the SUPG-part on matrix block A after
...
C
************************************************************************
      SUBROUTINE tadstp(U1L1,U1L2,U2L1,U2L2,A1L,A2L,U1,U2,D1,D2,A,NA,
     *                  KCOLA,KLDA,KVERT,KMID,DCORVG,ELE,COEF,
     *                  IDEF,ICOMP,DCMASS)
************************************************************************
*     Purpose: -  Adds the SUPG-part on matrix block A after
...
C
       DO 235 IDOFE=1,IDFL
       IF (IDOFE.EQ.JDOFE) THEN
             AH= DNY*(HBASJ2**2+HBASJ3**2)+CT0*HBASJ1**2
       ELSE
        IDOFEH=KDFL(IDOFE)
        HBASI1=DBAS(IDOFEH,1)
        HBASI2=DBAS(IDOFEH,2)
        HBASI3=DBAS(IDOFEH,3)
             AH= DNY*(HBASJ2*HBASI2+HBASJ3*HBASI3)
     *         +   CT0*HBASJ1*HBASI1
       ENDIF
C
            DENTRY(JDOFE,IDOFE)=DENTRY(JDOFE,IDOFE)+OM*AH
...
C
************************************************************************
      SUBROUTINE tadstn(U1L1,U1L2,U2L1,U2L2,A1L,A2L,U1,U2,D1,D2,A,NA,
     *                  KCOLA,KLDA,KVERT,KMID,DCORVG,ELE,COEF,
     *                  IDEF,ICOMP,DCMASS)
************************************************************************
*     Purpose: -  Adds the SUPG-part on matrix block A after
