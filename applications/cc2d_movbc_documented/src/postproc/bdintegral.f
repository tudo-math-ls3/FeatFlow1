...
*  KVERT, KMID  - Arrays with information about the parametrisation
...
*
* SUBROUTINE CINIT (IINFO,NIINFO,DINFO,NDINFO,DU1,DU2,DP,ELE,BNONPR)
* --------------------------------------------------------------------
* IMPLICIT NONE
...
* 
* SUBROUTINE CDONE (IINFO,NIINFO,DINFO,NDINFO,DU1,DU2,DP,ELE,BNONPR)
* --------------------------------------------------------------------
* IMPLICIT NONE
* INTEGER NIINFO,IINFO(NIINFO),NDINFO
* LOGICAL BNONPR
...
*                    IELEM,ELE,BNONPR)
* --------------------------------------------------------------------
* INTEGER NIINFO,IINFO(NIINFO),NDINFO,IELEM
* LOGICAL BNONPR
* DOUBLE PRECISION DINFO(NDINFO),DU1(*),DU2(*),DP(*)
* EXTERNAL ELE
...
*
* All parameters are calculated in VOLINT and passed to these
...
**********************************************************************
      ...
      SUBROUTINE VOLINT (DU1,DU2,DP,KVERT,KMID,
     *    DCORVG,NEL,NVE,ELE,BNONPR,ICUB,
...
C parameters
      ...
      DOUBLE PRECISION DU1(*),DU2(*),DP(*),DCORVG(2,*)
      INTEGER KVERT(NNVE,*),KMID(NNVE,*)
      INTEGER ICUB
      LOGICAL BNONPR
      
      INTEGER NIINFO,IINFO(NIINFO),NDINFO,NEL,NVE
...
C User defined initialisation
      ...
      CALL CINIT (IINFO,NIINFO,DINFO,NDINFO,DU1,DU2,DP,ELE,BNONPR)
...
C Calculate user defined values and derivatives:
     ...
     *                 XX,YY,XI1,XI2,ICUBP,IEL,ELE,BNONPR)
...
C the cleanup if necessary
      ...
      CALL CDONE (IINFO,NIINFO,DINFO,NDINFO,DU1,DU2,DP,ELE,BNONPR)
...
*  KVERT, KMID  - Arrays with information about the parametrisation
*  DCORVG       - Coordinates of vertices
*  DCORMG       - Coordinate of midpoints
*  NEL          - Number of elements
*  NVE          - Number of vertices per element
*  BNONPR       - Type of element: 
*                  false = parametric element (E0xx)
...
* see above
*
* SUBROUTINE CGETLN (IINFO,NIINFO,DINFO,NDINFO,IELEM,
**                   DCORVG,KVERT,DCORMG,KMID,NEL,NVE,                 
**                   X1,Y1,X2,Y2,BDOINT)
* --------------------------------------------------------------------
* IMPLICIT NONE
* INTEGER NIINFO,IINFO(NIINFO),NDINFO,IELEM
...
**********************************************************************
      ...
      SUBROUTINE LININT (DU1,DU2,DP,DCORVG,KVERT,DCORMG,KMID,
     *    NEL,NVE,ELE,BNONPR,ICUB,
     *    IINFO, NIINFO, DINFO, NDINFO,
...
C Is there at all a line on the current element?
        ...
        BDOINT = .FALSE.
        CALL CGETLN (IINFO,NIINFO,DINFO,NDINFO,IEL,
     *               DCORVG,KVERT,DCORMG,KMID,NEL,NVE,
     *               X1,Y1,X2,Y2,BDOINT)
