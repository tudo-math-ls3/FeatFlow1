...
C First rotor
          ...
          WRITE (FNAME,'(A)') 'maleRotor_44_Punkte.txt'
C          WRITE (FNAME,'(A)') 'maleRotor_400_Punkte.txt'
...
C 2nd rotor
          ...
          WRITE (FNAME,'(A)') 'femaleRotor_47_Punkte.txt'
C          WRITE (FNAME,'(A)') 'femaleRotor_399_Punkte.txt'
          CALL GINRTR (GEOIDX, GEOCOM, ITYPE, FNAME, PAR1)
