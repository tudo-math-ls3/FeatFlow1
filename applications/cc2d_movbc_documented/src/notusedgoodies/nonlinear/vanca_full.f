     ...
     *    kvert,kmid,kxnpr,nel,nvt,rlxsm)
************************************************************************
c
...
c parameters
      ...
      double precision f1(*),f2(*),fp(*),rlxsm
      double precision a(*),b1(*),b2(*)
      integer kcola(*),klda(*),kcolb(*),kldb(*)
      integer kvert(nnve,*),kmid(nnve,*),kxnpr(2,*)
      integer nu,np
      integer nel,nvt
...
c *** local arrays for informations about one element
      ...
      double precision aa(nnld,nnld),ff(1,nnld)
      integer ipiv(nnld)
      integer iu(4)
