...
C *** COMMON blocks for time discretization
      ...
      SAVE
C
      RHS=FDATIN(5,IBLOC,X,Y,TIMENS,RE,TSTEP)
C
      END
C
C
...
C *** COMMON blocks for time discretization
      ...
      SAVE
C     
      UE=FDATIN(1,IBLOC,X,Y,TIMENS,RE,TSTEP)
C
      END
C
************************************************************************
...
C *** COMMON blocks for time discretization
      ...
      SAVE
C     
      PE=FDATIN(4,IBLOC,X,Y,TIMENS,RE,TSTEP)
C
      END
C
*************************************************************************
...
C *** COMMON blocks for time discretization
      ...
      SAVE
C     
      UEX=FDATIN(2,IBLOC,X,Y,TIMENS,RE,TSTEP)
C
      END
C
*************************************************************************
...
C *** COMMON blocks for time discretization
      ...
      SAVE
C
      UEY=FDATIN(3,IBLOC,X,Y,TIMENS,RE,TSTEP)
C
      END
