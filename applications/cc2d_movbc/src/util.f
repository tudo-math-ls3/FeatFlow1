...
************************************************************************
      ...
      PARAMETER (NNVE=4)
C
      DIMENSION DU1(*),DU2(*),DL1(*),DL2(*),DAUX(*),KVERT(NNVE,*),
     *          KMID(NNVE,*),KVBD(*),KMBD(*),DCORVG(2,*),
     *          KNPR(*)
C
      SAVE
C-----------------------------------------------------------------------
...
ccc      goto 10
      IF (INPR1.EQ.11) DL1(IV1)=0D0
      IF (INPR1.EQ.11) DL2(IV1)=0D0
      IF (INPR2.EQ.11) DL1(IV2)=0D0
      IF (INPR2.EQ.11) DL2(IV2)=0D0
      IF (INPR3.EQ.11) DL1(IV3)=0D0
      IF (INPR3.EQ.11) DL2(IV3)=0D0
      IF (INPR4.EQ.11) DL1(IV4)=0D0
      IF (INPR4.EQ.11) DL2(IV4)=0D0
C
10    CONTINUE
C
      DO 20  IV=1,NVT
...
ccc      goto 10
      IF (INPR1.EQ.11) DPL(IV1)=0D0
      IF (INPR2.EQ.11) DPL(IV2)=0D0
      IF (INPR3.EQ.11) DPL(IV3)=0D0
      IF (INPR4.EQ.11) DPL(IV4)=0D0
C
10    CONTINUE
C
C
...
c
************************************************************************
      SUBROUTINE   U2ISO (DCORVG,KVERT,KMID,KADJ,KNPR,DVIND,DX,DU1,DU2)
************************************************************************
*
...
ccc      IF (INPRH.EQ.11) DX(IVTH)=0D0
14    IND=INDH
C
C
20    DO 22 IME=1,NVE
