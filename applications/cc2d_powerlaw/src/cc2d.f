...
************************************************************************
*
*   Purpose: - solver for the stationary and nonstationary 
*              incompressible Navier Stokes equations via time adaptive 
*              fixed point defect correction
*              plus coupled multigrid for linear problems
*            - nonlinear iteration for Oseen equations:
*                   - fixed point defect correction as outer iteration
*                   - mg as solver for linear auxiliary Oseen problems
