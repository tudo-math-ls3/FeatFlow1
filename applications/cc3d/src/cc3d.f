...
************************************************************************
*
*   Purpose: - solver for the stationary incompressible 3D-Navier Stokes
*              equations via fixed point defect correction plus
*              imultigrid for linear problems
*            - nonlinear version:
*                   - simple iteration as outer iteration
*                   - mg (M011) as solver for the linear auxiliary
*                     problems
