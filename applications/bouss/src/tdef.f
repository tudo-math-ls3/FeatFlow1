...
C
        IF (IUPW.EQ.1) THEN
         CALL GUPWD(DWORK(KU1),DWORK(KU2),
     *              DWORK(KU1),DWORK(KU2),1.d0,0.d0,
     *              DWORK(KT),DWORK(KT),
     *              DWORK(L(LDT)),DWORK(L(LDT)),VWORK(KA1),KWORK(KCOLA),
     *              KWORK(KLDA),KWORK(L(LVERT)),KWORK(L(LMID)),
     *              DWORK(L(LCORVG)),IDEFUP,1)
        ELSE
         IF (IELT.EQ.0) 
     *    CALL SUPWDG(DWORK(KU1),DWORK(KU2),
     *                DWORK(KU1),DWORK(KU2),1.d0,0.d0,
     *                DWORK(KT),DWORK(KT),
     ...
     *                E030,COEFFN,IDEFUP,1,1D0)
         IF (IELT.EQ.2) 
     *    CALL SUPWNP(DWORK(KU1),DWORK(KU2),
     *                DWORK(KU1),DWORK(KU2),1.d0,0.d0,
     *                DWORK(KT),DWORK(KT),
     *                DWORK(L(LDT)),DWORK(L(LDT)),
     *                VWORK(KA1),NA,KWORK(KCOLA),KWORK(KLDA),
...
C
     ...
     *                EM30,COEFFN,IDEFUP,1,1D0)
       ...
       ENDIF
C
      CALL BDRYAT (VWORK(KA1),KWORK(KCOLA),KWORK(KLDA),
