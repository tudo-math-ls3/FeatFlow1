...
************************************************************************
*
*   Purpose: - estimator for storage amount for pp2d
*
************************************************************************
C
...
C
      IF (ILUC  .EQ.1) NWORKF=NWORKF+3
      IF (ISORTP.GT.0) NWORKF=NWORKF+1
C
      IF (ILUU  .EQ.1) NWORKF=NWORKF+9
      IF (ISORTU.GT.0) NWORKF=NWORKF+3
C
...
C
      IF (ITEXL .NE.0) THEN
       NWORKF=NWORKF+4
       IF (ABS(IADTIM).EQ.3) NWORKF=NWORKF+4
      ENDIF
C
C
C
